...
<div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="project.php?url=home" class="nav-link link-dark <?php if ($_GET['url'] == 'home') echo 'active'; ?>" aria-current="page">
        ...
        ?>
            <li>
                <a href="datapeminjam.php?url=pinjam" class="nav-link link-dark <?php if ($_GET['url'] == 'pinjam') echo 'active'; ?>">
        ...
        ?>
            <li>
                <a href="record.php?url=record" class="nav-link link-dark <?php if ($_GET['url'] == 'record') echo 'active'; ?>">
                    <svg class="bi me-2" width="16" height="16">
