...
<body>
                        ...
                        <?php foreach ($select as $sl) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <!-- Tombol Pinjam -->
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#examplepinjam<?= $sl["id"]; ?>">
                                            Pinjam
                                        </button>
                                    <?php
                                    }
    ...
    ?>
        <?php foreach ($select as $sl) : ?>
            <div class="modal fade" id="examplepinjam<?= $sl["id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
